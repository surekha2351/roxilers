...
function App() {
  ...
  const getStatData = async (m) => {
    let resp = await axios.get(
      `https://roxilerbackend.onrender.com/product?month=${m}`
    );
    setStat(resp?.data);
  };
  ...
  return (
    <div className="bg-gray-900 h-auto pl-[10%] pr-[10%] pt-[3rem] pb-[5rem] text-white ">
      <div className="text-2xl flex justify-center items-center text-center rounded-[50%] bg-blue-300 h-[13rem] w-[17%] m-auto">
      ...
      <div className="mt-[3rem] flex justify-between ">
        ...
        <div className="mt-[3rem] ">
          Select month:{" "}
          <select
            className="bg-red-100 text-black p-[0.5rem] rounded-full pl-[-.3rem] pr-[-.3rem]"
            value={month}
      ...
      <div className="mt-[1rem] flex items-center justify-between">
        ...
        <div>
          ...
          <span>-</span>
          <button
            className="border-2 bg-red-200 text-black p-[0.5rem] rounded-lg"
        ...
        <div>
          ...
          <select
            name=""
            id=""
            className="text-black border-2 bg-orange-200"
      ...
      <div className="text-center mt-[3rem]">
        ...
        <div className="w-[300px] m-auto rounded-xl bg-yellow-300 mt-2 flex flex-col text-left  p-[2rem]">
